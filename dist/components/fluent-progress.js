 ...
 */
class FluentProgress extends thoriumjs_1.UserInterface.ElementUI {
    constructor(options) {
        super({
            type: 'fluent-progress',
...
exports.FluentProgress = FluentProgress;
//# sourceMappingURL=fluent-progress.js.map